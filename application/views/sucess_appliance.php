    ...
    <div class="new_list">
        <ul>
            ...
            foreach( $appliances as $appliance ){
                ?>
                <li><a href="#"><div class="new_commodity"><span>欢迎选购本商品</span></div><p>介绍:<?php echo $appliance->title?></p><img src="<?php echo $appliance->img?>" alt=""><p class="date"><?php echo $appliance->post_date?></p><sapn class="price">价格￥：<?php echo $appliance->price?></sapn></a></li>
                <?php
            }
            ?>
