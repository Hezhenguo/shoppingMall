...
<!--                                                <li><a href="#"><div class="new_commodity"><span>欢迎选购本商品</span></div><p>介绍:卡地亚</p><img src="img/air1.jpg" alt=""><p class="date">2017-01-01</p><sapn class="price">价格￥：</sapn></a></li>-->
        ...
        ?>
                <li><a href="welcome/passport_login"><div class="new_commodity"><span>欢迎选购本商品</span></div><p>介绍:<?php echo $phone->title?></p><img src="<?php echo $phone->img?>" alt=""><p class="date"><?php echo $phone->post_date?></p><sapn class="price">价格￥：<?php echo $phone->price?></sapn></a></li>
            <?php
            }
            ?>
