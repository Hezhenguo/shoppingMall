...
<div class="wrap">
    <ul class="list1">
        ...
        foreach($commoditys as $commodity ) {
            ?>
            <li class="items"><a href="welcome/validation_user"><img src="<?php echo $commodity->img?>" alt=""><p><?php echo $commodity->title;?></p><span class="titles">价钱:￥<?php echo $commodity->price;?></span></a></li>
            <?php
        }
        ?>
