    ...
    <div class="new_list">
        <ul class="star_list">
            ...
            foreach($computers as $computer){
                ?>
                <li><a href="#"><div class="new_commodity"><span>欢迎选购本商品</span></div><p>介绍:<?php echo $computer->title?></p><img src="<?php echo $computer->img?>" alt=""><p class="date"><?php echo $computer->post_date?></p><sapn class="price">价格￥：<?php echo $computer->price?></sapn></a></li>
                <?php
            }
            ?>
